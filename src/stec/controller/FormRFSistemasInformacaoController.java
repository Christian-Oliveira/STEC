...
public class FormRFSistemasInformacaoController implements Initializable, IFormulario {

	Resposta resposta = new Resposta();
	FormRFSistemasInformacao formulario = new FormRFSistemasInformacao();
	...
	@FXML
	private JFXComboBox<String> cbSistemas;
	@FXML
	private JFXComboBox<String> cbAvaliacao;
        @FXML
        private Label lblSistemas;
        @FXML
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		cbSistemas.getSelectionModel().selectedItemProperty().addListener((observable, oldValue,
				newValue) -> adicionarComentario(newValue, "Sistemas de informação"));
	}
	...
	private void handleAdicionar(ActionEvent event) {
		...
		formulario.setSistemas(cbSistemas.getSelectionModel().getSelectedItem());
	...
	public void carregarComboboxOpcoes() {
		...
		cbSistemas.setItems(observableOpcoes);
	}
	...
	public void setResposta(Resposta resposta) {
		...
		if (resposta.getResposta() != null) {
			...
			FormRFSistemasInformacao formulario = gson.fromJson(resposta.getResposta(), FormRFSistemasInformacao.class);

			cbSistemas.getSelectionModel().select(formulario.getSistemas());
	...
	public void setDialog(Stage dialog) {
        ...
        public boolean validarDados(){
            boolean error = false;
            if (cbSistemas.getSelectionModel().isEmpty()){
                error = true;
                lblSistemas.setStyle("-fx-text-fill:red");
            }
	...
	public class FormRFSistemasInformacao {
