...
public class FormAMAcessoController implements Initializable, IFormulario {
    
    Resposta resposta = new Resposta();
    FormAMAcesso formulario = new FormAMAcesso();
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbAcesso.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> adicionarComentario(newValue, "Acesso aos mercados"));
    }    
    ...
    private void handleAdicionar(ActionEvent event) {
        if (validarDados()){
            ...
            formulario.setAcesso(cbAcesso.getSelectionModel().getSelectedItem());
    ...
    public void carregarComboboxOpcoes(){
        ...
        cbAcesso.setItems(observableOpcoes);
    ...
    public void setResposta(Resposta resposta) {
        ...
        if (resposta.getResposta() != null) {
            ...
            FormAMAcesso formulario = gson.fromJson(resposta.getResposta(), FormAMAcesso.class);
            
            cbAcesso.getSelectionModel().select(formulario.getAcesso());
    ...
    public boolean validarDados(){
        boolean error = false;
        if (cbAcesso.getSelectionModel().isEmpty()){
            error = true;
            lblAcesso.setStyle("-fx-text-fill:red");
        }
