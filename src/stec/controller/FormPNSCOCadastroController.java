...
public class FormPNSCOCadastroController implements Initializable, IFormulario {

	Resposta resposta = new Resposta();
	FormPNSCOCadastros formulario = new FormPNSCOCadastros();
	...
	@FXML
	private JFXComboBox<String> cbEstabelecimentoCadastro;
	@FXML
	private JFXComboBox<String> cbAtualizacaoCadastral;
	@FXML
	private JFXComboBox<String> cbAvaliacao;
        @FXML
        private Label lblEstabelecimentoCadastro;
        @FXML
	...
	public void initialize(URL url, ResourceBundle rb) {
		...
		cbEstabelecimentoCadastro.getSelectionModel().selectedItemProperty().addListener((observable, oldValue,
	...
	private void handleAdicionar(ActionEvent event) {
		...
		formulario.setEstabelecimentoCadastrado(cbEstabelecimentoCadastro.getSelectionModel().getSelectedItem());
	...
	public void carregarComboboxOpcoes() {
		...
		cbEstabelecimentoCadastro.setItems(observableOpcoes);
	...
	public void setResposta(Resposta resposta) {
		...
		if (resposta.getResposta() != null) {
			...
			FormPNSCOCadastros formulario = gson.fromJson(resposta.getResposta(), FormPNSCOCadastros.class);

			cbAtualizacaoCadastral.getSelectionModel().select(formulario.getAtualizacaoCadastral());
			cbEstabelecimentoCadastro.getSelectionModel().select(formulario.getEstabelecimentoCadastrado());
	...
	public void setDialog(Stage dialog) {
        ...
        public boolean validarDados(){
            boolean error = false;
            if (cbEstabelecimentoCadastro.getSelectionModel().isEmpty()){
                error = true;
                lblEstabelecimentoCadastro.setStyle("-fx-text-fill:red");
            }
	...
	public class FormPNSCOCadastros {
