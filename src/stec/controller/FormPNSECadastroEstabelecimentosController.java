...
public class FormPNSECadastroEstabelecimentosController implements Initializable, IFormulario {
    
    Resposta resposta = new Resposta();
    FormPNSECadastroEstabelecimento formulario = new FormPNSECadastroEstabelecimento();
    ...
    @FXML
    private JFXComboBox<String> cbEstabelecimentoCadastros;
    @FXML
    private JFXComboBox<String> cbAtualizacaoCadastral;
    @FXML
    private JFXComboBox<String> cbAvaliacao;
    @FXML
    private Label lblEstabelecimentoCadastros;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
		...
		cbEstabelecimentoCadastros.getSelectionModel().selectedItemProperty().addListener((observable, oldValue,
    ...
    private void handleAdicionar(ActionEvent event) {
        if (validarDados()){
            ...
            formulario.setEstabelecimentoCadastrado(cbEstabelecimentoCadastros.getSelectionModel().getSelectedItem());
    ...
    public void carregarComboboxOpcoes(){
        ...
        cbEstabelecimentoCadastros.setItems(observableOpcoes);
    ...
    public void setResposta(Resposta resposta) {
        ...
        if (resposta.getResposta() != null) {
            ...
            FormPNSECadastroEstabelecimento formulario = gson.fromJson(resposta.getResposta(), FormPNSECadastroEstabelecimento.class);
            
            cbAtualizacaoCadastral.getSelectionModel().select(formulario.getAtualizacaoCadastral());
            cbEstabelecimentoCadastros.getSelectionModel().select(formulario.getEstabelecimentoCadastrado());
    ...
    public boolean validarDados(){
        boolean error = false;
        if (cbEstabelecimentoCadastros.getSelectionModel().isEmpty()){
            error = true;
            lblEstabelecimentoCadastros.setStyle("-fx-text-fill:red");
        }
    ...
    public class FormPNSECadastroEstabelecimento {
        
        private String estabelecimentoCadastrado;
        ...
        public FormPNSECadastroEstabelecimento() {
        }
        ...
        public String getEstabelecimentoCadastrado() {
            return estabelecimentoCadastrado;
        }

        public void setEstabelecimentoCadastrado(String estabelecimentoCadastrado) {
            this.estabelecimentoCadastrado = estabelecimentoCadastrado;
        }
