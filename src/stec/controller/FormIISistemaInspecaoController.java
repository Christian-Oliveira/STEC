...
public class FormIISistemaInspecaoController implements Initializable, IFormulario {
    
    Resposta resposta = new Resposta();
    FormIISistemaInspecao formulario = new FormIISistemaInspecao();
    ...
    @FXML
    private JFXComboBox<String> cbInteracaoInspecao;
    @FXML
    private JFXComboBox<String> cbAvaliacao;
    @FXML
    private Label lblInteracaoInspecao;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbInteracaoInspecao.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> adicionarComentario(newValue, "Interação com sistema de inspeção"));   
    }    
    ...
    private void handleAdicionar(ActionEvent event) {
        if (validarDados()){
            ...
            formulario.setInteracaoInspecao(cbInteracaoInspecao.getSelectionModel().getSelectedItem());
    ...
    public void carregarComboboxOpcoes(){
        ...
        cbInteracaoInspecao.setItems(observableOpcoes);   
    ...
    public void setResposta(Resposta resposta) {
        ...
        if (resposta.getResposta() != null) {
            ...
            FormIISistemaInspecao formulario = gson.fromJson(resposta.getResposta(), FormIISistemaInspecao.class);
            
            cbInteracaoInspecao.getSelectionModel().select(formulario.getInteracaoInspecao());
    ...
    public boolean validarDados(){
        boolean error = false;
        if (cbInteracaoInspecao.getSelectionModel().isEmpty()){
            error = true;
            lblInteracaoInspecao.setStyle("-fx-text-fill:red");
        }
    ...
    public class FormIISistemaInspecao {
        
        private String interacaoInspecao;
        ...
        public String getInteracaoInspecao() {
            return interacaoInspecao;
        }

        public void setInteracaoInspecao(String interacaoInspecao) {
            this.interacaoInspecao = interacaoInspecao;
        }
