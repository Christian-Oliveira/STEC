...
public class FormIMVHabilitacaoController implements Initializable, IFormulario {
    
    Resposta resposta = new Resposta();
    FormIMVHabilitacao formulario = new FormIMVHabilitacao();
    ...
    @FXML
    private JFXComboBox<String> cbInteracaoMV;
    @FXML
    private JFXComboBox<String> cbAvaliacao;
    @FXML
    private Label lblInteracaoMV;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbInteracaoMV.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> adicionarComentario(newValue, "Interação com MVs cadastrados/habilitados"));
    }    
    ...
    private void handleAdicionar(ActionEvent event) {
        if (validarDados()){
            ...
            formulario.setInteracaoMV(cbInteracaoMV.getSelectionModel().getSelectedItem());
    ...
    public void carregarComboboxOpcoes(){
        ...
        cbInteracaoMV.setItems(observableOpcoes);
    ...
    public void setResposta(Resposta resposta) {
        ...
        if (resposta.getResposta() != null) {
            ...
            FormIMVHabilitacao formulario = gson.fromJson(resposta.getResposta(), FormIMVHabilitacao.class);
            
            cbInteracaoMV.getSelectionModel().select(formulario.getInteracaoMV());
    ...
    public boolean validarDados(){
        boolean error = false;
        if (cbInteracaoMV.getSelectionModel().isEmpty()){
            error = true;
            lblInteracaoMV.setStyle("-fx-text-fill:red");
        }
    ...
    public class FormIMVHabilitacao {
        
        private String interacaoMV;
        ...
        public String getInteracaoMV() {
            return interacaoMV;
        }

        public void setInteracaoMV(String interacaoMV) {
            this.interacaoMV = interacaoMV;
        }
