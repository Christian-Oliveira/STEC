...
public class FormIISUSController implements Initializable, IFormulario {
    
    Resposta resposta = new Resposta();
    FormIISUS formulario = new FormIISUS();
    ...
    @FXML
    private JFXComboBox<String> cbInteracaoSUS;
    @FXML
    private JFXComboBox<String> cbAvaliacao;
    @FXML
    private Label lblInteracaoSUS;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        cbInteracaoSUS.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> adicionarComentario(newValue, "Interação com sistema Único de saúde"));
    }    
    ...
    private void handleAdicionar(ActionEvent event) {
        if (validarDados()){
            ...
            formulario.setInteracaoSUS(cbInteracaoSUS.getSelectionModel().getSelectedItem());
    ...
    public void carregarComboboxOpcoes(){
        ...
        cbInteracaoSUS.setItems(observableOpcoes);
    ...
    public void setResposta(Resposta resposta) {
        ...
        if (resposta.getResposta() != null) {
            ...
            FormIISUS formulario = gson.fromJson(resposta.getResposta(), FormIISUS.class);
            
            cbInteracaoSUS.getSelectionModel().select(formulario.getInteracaoSUS());
    ...
    public boolean validarDados(){
        boolean error = false;
        if (cbInteracaoSUS.getSelectionModel().isEmpty()){
            error = true;
            lblInteracaoSUS.setStyle("-fx-text-fill:red");
        }
    ...
    public class FormIISUS {
        
        private String interacaoSUS;
        ...
        public String getInteracaoSUS() {
            return interacaoSUS;
        }

        public void setInteracaoSUS(String interacaoSUS) {
            this.interacaoSUS = interacaoSUS;
        }
